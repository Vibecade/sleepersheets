      ...
      <CardHeader className="pb-3">
        <div className="flex items-center justify-between">
          <div className="flex items-center space-x-2">
            ...
            <CardTitle className="text-base sm:text-lg">League Standings</CardTitle>
          </div>
          <div className="flex items-center space-x-2">
          ...
          <div className="space-y-2.5 pr-2">
            {rosters
              ...
              .map((roster, index) => {
                ...
                return (
                  <div key={roster.roster_id} className="flex items-center justify-between p-3 bg-white/5 rounded-lg border border-white/10 transition-all duration-200 hover:bg-white/10 hover:border-white/20 touch-manipulation">
                    <div className="flex items-center space-x-3">
                      <div className="relative">
                        ...
                        <div className={`absolute -bottom-1 -right-1 w-6 h-6 rounded-full flex items-center justify-center text-xs font-bold transition-all duration-200 ${
